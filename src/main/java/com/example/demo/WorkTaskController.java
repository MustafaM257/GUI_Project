...
public class WorkTaskController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        button_createtask.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                    if (name.getText().isEmpty() || description.getText().isEmpty() || project.getText().isEmpty() || datePicker.getValue() == null) {
                        ...
                        else if(project.getText().isEmpty()){
