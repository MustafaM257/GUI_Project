    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        button_createtask.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (name.getText().isEmpty() || description.getText().isEmpty() || store.getText().isEmpty() || datePicker.getValue() == null) {
                    ...
                    else if(store.getText().isEmpty()){
                        alert.setContentText("Please specify the project name of your task");
                    }
                    alert.showAndWait();
                    return;
                } else {
                    boolean success = DB.addTaskToDatabase(name.getText(), description.getText(), store.getText(), Date.valueOf(datePicker.getValue()), "shopping", User.getInstance().getUserid());
